...
const Sidebar = () => {
    ...
    const handleLinkClick = (path, message) => {
        console.log(message);
        navigate(path);
    };

    return (
        <nav id="main-nav" className="hc-offcanvas-nav sidebar">
            <ul className="second-nav">
                <li className="osahan-user-profile bg-primary">
                    <div className="d-flex align-items-center gap-2 sidebar-top-view">
                        <img src={favorite4} alt="User" className="rounded-pill img-fluid" />
                        <div className="ps-1">
                ...
                <li>
                    <a href="index.html"><span className="mdi mdi-cellphone me-3"></span>Splash</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#"><span className="mdi mdi-file me-3"></span>Case Management</a>
                    <ul>
                        <li><Link to={"/signup"}>Chief Complaint</Link></li>
                        <li><a onClick={() => handleLinkClick("/associate-complaint", "Associate Complaint clicked")}>Associate Complaint</a></li>
                        <li><a onClick={() => handleLinkClick("/case-record", "Case Record clicked")}>Case Record</a></li>
                        <li><a onClick={() => handleLinkClick("/upload-case-record", "Upload Case Record clicked")}>Upload Case Record</a></li>
                        <li><a onClick={() => handleLinkClick("/add-diagnosis", "Add Diagnosis (SFFT) clicked")}>Add Diagnosis (SFFT)</a></li>
                        <li><a onClick={() => handleLinkClick("/add-life-space-table", "Add Life Space Table (LST) clicked")}>Add Life Space Table (LST)</a></li>
                        <li><a onClick={() => handleLinkClick("/add-data", "Add Data clicked")}>Add Data</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="request-appointment.html"><span className="mdi mdi-calendar-check me-3"></span>Request Appointment</a></li>
