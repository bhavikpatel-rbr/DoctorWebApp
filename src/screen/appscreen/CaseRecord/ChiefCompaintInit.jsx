                ...
                <ul className="list-group">
                  {currentOptions.map((option, index) => (
                    <li
                      ...
                      onClick={() => handleOptionSelect(option)} // Handle selection on clicking the list item
                      style={{ cursor: "pointer" }} // Change the cursor to a pointer to indicate it's clickable
                    >
                      <input
                        type="checkbox"
                        checked={selectedOptions.includes(option)}
                        onChange={() => handleOptionSelect(option)} // Handle selection on clicking the checkbox
                        onClick={(e) => e.stopPropagation()} // Prevent triggering the parent <li> onClick event when clicking the checkbox
                      />
                      {option}
                    </li>
                  ))}
