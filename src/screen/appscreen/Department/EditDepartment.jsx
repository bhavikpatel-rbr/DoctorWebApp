...
const EditDepartment = () => {
  const [departmentName, setDepartmentName] = useState('Urology');
  const [departmentHead, setDepartmentHead] = useState('Tushar Joshi');
  const [description, setDescription] = useState('Investigates and treats proble...');
  const [departmentDate, setDepartmentDate] = useState('28-11-22');
